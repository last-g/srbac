...
//  }
  ...
  protected function afterSave() {
    ...
    if($this->oldName != $this->name) {
      ...
      AssignmentsGroup::model()->updateAll(array('itemname'=>$this->name),$criteria);
      $criteria->condition = "parent='".$this->oldName."'";
      AuthItemHierarchy::model()->updateAll(array('parent'=>$this->name), $criteria);
      $criteria->condition = "child='".$this->oldName."'";
      AuthItemHierarchy::model()->updateAll(array('child'=>$this->name),$criteria);
  ...
  protected function afterDelete() {
    ...
    AssignmentsGroup::model()->deleteAll("itemname='".$this->name."'");
    AuthItemHierarchy::model()->deleteAll( "parent='".$this->name."'");
    AuthItemHierarchy::model()->deleteAll("child='".$this->name."'");
  }
}